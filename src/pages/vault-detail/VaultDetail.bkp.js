...
import { Form, FormGroup, Label, Input, UncontrolledTooltip, UncontrolledButtonDropdown, InputGroup, InputGroupAddon } from "reactstrap";
      ...
      <div className={s.root}>
        ...
        <Row>
          ...
          <Col md={6} sm={12} xs={12}>
            <Widget title={<p style={{ fontWeight: 700 }}>AMPL Wallet Balance: {staking_token_balance}</p>}>
              <div>
                <FormGroup>
                ...
                <p className="fs-mini text-muted">New deposits locked for 90 days.</p>
                <p className={"d-flex align-items-center "} align="center">
                  <Button color="default" size="lg" align="center" className="mb-md mr-sm">
                    Deposit
                  </Button>
                </p>
              </div>
          ...
          {/* Size variants */}
          <Col md={6} sm={12} xs={12}>
            <Widget title={<p style={{ fontWeight: 700 }}>AMPL Available to Withdraw: 5,169 AMPL</p>}>
              <div>
                <FormGroup>
                  <Label for="bar">Amount to Deposit</Label>
                  <Table className="table-hover " responsive>
                ...
                <p className="fs-mini text-muted">Unlocked AMPL</p>
            ...
            <Widget>
                  ...
                  <tbody className="text-dark ">
                    <tr key={0}>
                      <td className="fw-thin pl-0 fw-thin">
                        ...
                        <p>
                          <h4>APY 60%</h4>
                          <br></br>Portion of AMPL sold during positive rebases, <br></br>Balance can decline during negative rebases.
                        </p>
                      </td>
              ...
              <p>
                <Table className="table-hover table-bordered" responsive>
                  ...
                  <tbody className="text-dark">
                    <tr key={0}>
                      <td className="fw-normal pl-0 fw-thin">&nbsp;2021/03/15</td>
                      <td className={"pl-0 fw-thin"}>&nbsp;1,745 AMPL</td>
                      <td className={"pl-0 fw-thin"}>
                        &nbsp;0xde...{" "}
                    ...
                    <tr key={1}>
                      <td className="fw-normal pl-0 fw-thin">&nbsp;2021/04/15</td>
                      <td className={"pl-0 fw-thin"}>&nbsp;1,445 AMPL</td>
                      <td className={"pl-0 fw-thin"}>
                        &nbsp;0xf3...{" "}
                        <a href="https://www.etherscan.io" target="_blank">
                          Link
