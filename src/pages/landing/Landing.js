                      ...
                      <div className={"text-info"}>
                        <div>
                          <span className={"d-flex "}>
                            <h2 className="display-4 d-flex text-left" style={{ fontSize: "46px" }}>
                              Unleash the power of your elastic assets
                            </h2>
                          </span>
                          <span className={"d-flex"}>
                            <h4 className="text-left">Earn token rewards, hedge against negative rebase and more.</h4>
                          </span>
                          <br />
                        </div>
                        <span className={"d-flex align-items-center "} responsive>
                          <Link to="/app/home/vault-summary">
                            <Button color="info" size="lg" className="mb-md mr-sm" responsive>
                              Launch App
                            </Button>
                          </Link>
                        </span>
              ...
              <div className="table-bordered" responsive>
                <div className={s.middleSection}>
                  <div className={s.middleDiv}>
                    ...
                    <p>Use your elastic assets to tap into a growing number of yield generation strategies, made possible by the rebase.</p>
                  </div>
                  <div className={s.middleDiv}>
                    <img height="240" src={p4} alt="" className={"mr-3"} />
                    <h3>Powered by the community</h3>
                    <p>Vault strategies are approved by holders of the kMPL governance token in exchange for token rewards.</p>
                  </div>
                  <div className={s.middleDiv}>
                    <img height="240" src={p3} alt="" className={"mr-3"} />
                    <h3>Connected to DeFi</h3>
                    <p>Vault strategies are optimized to connect elastic asset holders to the broader DeFi landscape.</p>
                  </div>
                </div>
              </div>
            </Col>
                ...
                <div responsive>
                  <div>
                    ...
                    <div key={0} width="30%" scope="col" className={"pl-0 text-info "} style={{ whiteSpace: "normal" }}>
                      <p className={"d-flex  "}>
                        &nbsp;
                        <h2 className="display-4 ">An AmpleSense DAO Project</h2>
                      </p>
                      <p className={"d-flex  align-items-center text-info"} style={{ whiteSpace: "normal" }}>
                        &nbsp;
                        <h5 className={"text-info "}>The DAO is an independant community powered organization focused on accelerating the global elastic finance ecosystem.</h5>
                      </p>
